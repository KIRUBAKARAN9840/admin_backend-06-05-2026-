...
class GymMembershipOffer(Base):
    """Owner-set offer pricing for membership plans.

    - plan_id=NULL → applies to ALL plans in the gym
    - plan_id=<id> → applies to that specific plan only
    Plan-specific offers take priority over gym-wide offers.
    """
