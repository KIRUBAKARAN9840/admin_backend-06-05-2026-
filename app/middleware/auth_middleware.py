...
class AuthMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        public_paths = ["/app_open/track","/owner/new_registration/register","/owner/new_registration/login","/owner/new_registration/otp_verification",
            ...
            "/chatbot","/analysis","/workout_template","/food_log","/food_template","/workout_log","/food_scanner","/owner/create_post","/owner/get_post","/webhooks/razorpay","/revenuecat/webhooks","/razorpay_payments/webhooks/razorpay","/marketing/auth/login","/marketing/auth/otp-verification","/marketing/auth/refresh","/marketing/auth/resend-otp","/razorpay_payments_v2/webhook","/revenuecat_v2/webhooks","/fymble_payments/googleplay/webhook","/fymble_payments/razorpay/webhook","/owner_registration/register","/owner_registration/check_already_registered","/owner_registration/verify-otp","/owner_registration/resend-otp","/owner_registration/document-steps","/owner_registration/update-gym-data","/owner_registration/account-details","/owner_registration/document-upload-url","/owner_registration/document-confirm","/owner_registration/get-documents",
            ...
            "/api/v2/client/new_registration/login","/api/v2/client/new_registration/verify-otp","/api/v2/client/new_registration/register","/api/v2/client/new_registration/resend-otp","/api/v2/app-config/check"]
