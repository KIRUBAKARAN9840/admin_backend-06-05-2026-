...
async def get_users_overview(
    ...
    try:
        ...
        # Imported Clients Data count (as requested: database level count from fittbot_gym_membership where type contains "imported")
        ...
        client_counts_data = {
            ...
            "imported_clients": imported_clients_count, # New metric
...
async def get_user_ai_credits_purchases(
    ...
    """Get AI Credit purchases for a specific user from payments table where flow is food_scanner_credits or food_scanner_credits_razorpay"""
    try:
...
async def get_user_last_purchases(
    ...
    try:
        ...
        try:
            ...
            # Find the FIRST one that matches nutrition_purchase_googleplay or nutrition_package_razorpay
        ...
        try:
            ...
            # Find the FIRST one that matches food_scanner_credits or food_scanner_credits_razorpay
