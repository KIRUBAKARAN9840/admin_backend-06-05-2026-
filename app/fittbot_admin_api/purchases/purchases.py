...
from sqlalchemy import select, or_, and_, not_, false, cast, Integer, func, union_all, literal, distinct, desc, asc
...
async def get_nutritionist_plans(
    ...
    Fetches from payments.payments table where payment_metadata['flow'] = 'nutrition_purchase_googleplay' or 'nutrition_package_razorpay'.
