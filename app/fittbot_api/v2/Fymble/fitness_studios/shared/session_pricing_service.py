...
class SessionPricingService:
    ...
    async def get_gym_pricing_breakdown(
        ...
        if offer_active:
            return actual_price, SESSION_OFFER_PRICE, True
    ...
    def is_offer_active(
        ...
        """Determine if session offer is active for a gym.

        Conditions: gym opted in + user eligible + gym < 50 promo users + user hasn't booked promo at this gym.
        """
