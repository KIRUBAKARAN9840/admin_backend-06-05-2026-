...
from app.utils.otp_security import secure_generate_otp
from app.config.settings import settings
from app.config.constants import OTP_EXPIRY_SECONDS
...
async def register_owner(
    ...
    try:
        ...
        otp = secure_generate_otp(request.mobile)
        await redis.set(f"otp:{request.mobile}", otp, ex=OTP_EXPIRY_SECONDS)
