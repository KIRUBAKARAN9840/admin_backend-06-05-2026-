...
def add_nutrition_purchase_entry_sync(
    ...
    """
    Sync version: Add 3 reward entries for a nutrition package purchase (max 15 total).
    Used by the Google Play nutrition processor which operates on a sync Session.
    """
    method = "nutrition_purchase"
    entries_to_add = 3
