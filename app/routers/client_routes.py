...
# ── V2 Domains ─────────────────────────────────────────────────────
from app.fittbot_api.v2.Fymble.fitness_studios.daily_pass.routes import router as v2_dailypass_router
from app.fittbot_api.v2.Fymble.fitness_studios.dailypass_bookings.routes import router as v2_dailypass_bookings_router
from app.fittbot_api.v2.Fymble.fitness_studios.sessions.routes import router as v2_sessions_router
from app.fittbot_api.v2.Fymble.fitness_studios.session_bookings.routes import router as v2_session_bookings_router
from app.fittbot_api.v2.Fymble.fitness_studios.gym_membership.routes import router as v2_membership_router
from app.fittbot_api.v2.Fymble.fitness_studios.gym_membership_bookings.routes import router as v2_membership_bookings_router
from app.fittbot_api.v2.Fymble.nutrition_purchase.routes import router as v2_nutrition_purchase_router
from app.fittbot_api.v2.Fymble.diet.diet_apis.routes import router as v2_diet_router
from app.fittbot_api.v2.Fymble.diet.personal_template.routes import router as v2_personal_template_router
from app.fittbot_api.v2.Fymble.diet.log_food.routes import router as v2_log_food_router
from app.fittbot_api.v2.Fymble.fitness_studios.personal_training.routes import router as v2_personal_training_router
from app.fittbot_api.v2.Fymble.fitness_studios.personal_training_bookings.routes import router as v2_pt_bookings_router
from app.fittbot_api.v2.Fymble.diet.diet_report.routes import router as v2_diet_report_router
from app.fittbot_api.v2.Fymble.bookings.dailypass.routes import router as v2_bookings_dailypass_router
from app.fittbot_api.v2.Fymble.bookings.sessions.routes import router as v2_bookings_sessions_router
from app.fittbot_api.v2.Fymble.bookings.gym_membership.routes import router as v2_bookings_membership_router
from app.fittbot_api.v2.Fymble.home.routes import router as v2_home_router
from app.fittbot_api.v2.Fymble.login.routes import router as v2_login_router
from app.fittbot_api.v2.Fymble.registration_steps.routes import router as v2_registration_steps_router
from app.fittbot_api.v2.Fymble.water.routes import router as v2_water_router
from app.fittbot_api.v2.Fymble.weight_progress.routes import router as v2_weight_progress_router
from app.fittbot_api.v2.Fymble.side_bar.routes import router as v2_sidebar_router
from app.fittbot_api.v2.Fymble.profile.routes import router as v2_profile_router
from app.fittbot_api.v2.Fymble.rewards.routes import router as v2_rewards_router
from app.fittbot_api.v2.Fymble_Payments.Subscriptions_AiCredits.credits.common_routes import router as v2_credits_common_router
from app.fittbot_api.v2.Fymble_Payments.Subscriptions_AiCredits.credits.googleplay.routes import router as v2_credits_gp_router
from app.fittbot_api.v2.Fymble_Payments.Subscriptions_AiCredits.credits.razorpay.routes import router as v2_credits_rp_router
from app.fittbot_api.v2.Fymble.nutrition_purchase_new.routes import router as v2_nutrition_purchase_new_router
from app.fittbot_api.v2.Fymble_Payments.nutrition_purchase_new.googleplay.routes import router as v2_nutrition_purchase_new_gp_router
from app.fittbot_api.v2.Fymble_Payments.nutrition_purchase_new.razorpay.routes import router as v2_nutrition_purchase_new_rp_router
from app.fittbot_api.v2.Fymble.nutrition.routes import router as v2_nutrition_page_router
from app.fittbot_api.v2.Fymble.apple_pg.routes import router as v2_apple_pg_router


# ── Food scanner ───────────────────────────────────────────────────────

from app.fittbot_api.v2.Fymble.workout.fittbot_workout.routes import router as v2_fittbot_workout_router
from app.fittbot_api.v2.Fymble.workout.log_workout.routes import router as v2_log_workout_router
from app.fittbot_api.v2.Fymble.diet.nutrition_diet.routes import router as v2_nutrition_diet_router
from app.fittbot_api.v2.Fymble.diet.food_scanner.routes import router as v2_food_scanner_router
from app.fittbot_api.v2.Fymble.diet.food_scanner.routes import diet_router as v2_diet_ai_router
from app.fittbot_api.v2.Fymble.app_config.routes import router as v2_app_config_router

#--- AI DIET Coach ---------

from app.fittbot_api.v2.Fymble.diet.chat_diet.routes import router as v2_chat_diet_router
...
# ── V2 ─────────────────────────────────────────────────────────────
router.include_router(v2_dailypass_router, prefix="/api/v2")
router.include_router(v2_dailypass_bookings_router, prefix="/api/v2")
router.include_router(v2_sessions_router, prefix="/api/v2")
router.include_router(v2_session_bookings_router, prefix="/api/v2")
router.include_router(v2_membership_router, prefix="/api/v2")
router.include_router(v2_membership_bookings_router, prefix="/api/v2")
router.include_router(v2_nutrition_purchase_router, prefix="/api/v2")
router.include_router(v2_diet_router, prefix="/api/v2")
router.include_router(v2_personal_template_router, prefix="/api/v2")
router.include_router(v2_log_food_router, prefix="/api/v2")
router.include_router(v2_personal_training_router, prefix="/api/v2")
router.include_router(v2_pt_bookings_router, prefix="/api/v2")
router.include_router(v2_diet_report_router, prefix="/api/v2")
router.include_router(v2_bookings_dailypass_router, prefix="/api/v2/bookings")
router.include_router(v2_bookings_sessions_router, prefix="/api/v2/bookings")
router.include_router(v2_bookings_membership_router, prefix="/api/v2/bookings")
router.include_router(v2_home_router, prefix="/api/v2")
router.include_router(v2_credits_common_router, prefix="/api/v2")
router.include_router(v2_credits_gp_router, prefix="/api/v2")
router.include_router(v2_credits_rp_router, prefix="/api/v2")
router.include_router(v2_nutrition_purchase_new_router, prefix="/api/v2")
router.include_router(v2_nutrition_purchase_new_gp_router, prefix="/api/v2")
router.include_router(v2_nutrition_purchase_new_rp_router, prefix="/api/v2")
router.include_router(v2_nutrition_page_router, prefix="/api/v2")
router.include_router(v2_apple_pg_router, prefix="/api/v2")
router.include_router(v2_login_router, prefix="/api/v2")
router.include_router(v2_registration_steps_router, prefix="/api/v2")
router.include_router(v2_water_router, prefix="/api/v2")
router.include_router(v2_weight_progress_router, prefix="/api/v2")
router.include_router(v2_sidebar_router, prefix="/api/v2")
router.include_router(v2_profile_router, prefix="/api/v2")
router.include_router(v2_rewards_router, prefix="/api/v2")
router.include_router(v2_fittbot_workout_router, prefix="/api/v2")
router.include_router(v2_log_workout_router, prefix="/api/v2")
router.include_router(v2_nutrition_diet_router, prefix="/api/v2")
router.include_router(v2_food_scanner_router, prefix="/api/v2")
router.include_router(v2_diet_ai_router, prefix="/api/v2")
router.include_router(v2_app_config_router, prefix="/api/v2")
router.include_router(v2_chat_diet_router, prefix="/api/v2")
